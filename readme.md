...
**/assets/js/vendor/jquery.touchSwipe.min.js** and the control script, **/assets/js/vendor/touchControl.js** are enqueued in the **carawebs_carousel_control()** function. Contents of touchControl.js:
